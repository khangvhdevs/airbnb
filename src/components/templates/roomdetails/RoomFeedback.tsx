...
export const RoomFeedback = () => {
    const { CommentsByRoomIdList: comments, RateAverage: rateAverage, FeedbackSum: feedbackSum } =
        ...
        <>
            <RoomFeedbackX>
                <RateHeader>
                    ...
                    <div>{rateAverage} · {feedbackSum} đánh giá</div>
                </RateHeader>
                            ...
                            <div>
                                <h2>
                                    <ModalHeading>
                                        ...
                                        <div>{rateAverage} · {comments?.length} đánh giá</div>
                                    </ModalHeading>
                                </h2>
                            </div>
                        </div>
